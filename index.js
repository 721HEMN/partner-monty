...
if (message.content.startsWith("https://discord.gg/")) {
  ...
  message.author.send(` دانرا تۆش ڕیکلامەکە بکە https://discord.gg/6UVtqFzPgB `) // لینکی سێرڤەری خۆت لیرە دابنی بە هەتا هەتای بێت
...
client.user.setGame(`MAUHAMAD DARKPLAN`) 
});




client.login("ODc4MDA4MzA0MDA0MTI4Nzk4.YR669A.JioRaHY1X8z4tYX3cncROmRyHIw");// Your Token
